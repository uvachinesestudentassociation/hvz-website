    ...
    >
      <div className="w-full max-w-lg border border-zinc-800 bg-zinc-900 p-6 shadow-2xl md:p-8">
        ...
        <p className="mt-3 text-sm leading-relaxed text-zinc-400">
          No peeking! The theme will be revealed soon...
        </p>

        {timeLeft && (
          <div className="mt-8">
            <p className="mb-3 font-mono text-xs uppercase tracking-[0.16em] text-zinc-500">
              Unlocks in
            </p>
        ...
        >
          <label
            htmlFor="exec-preview-code"
            className="block font-mono text-xs uppercase tracking-[0.14em] text-zinc-500"
          >
            Exec preview code
          </label>
